 ...
 */
sakai.createnotice = function(tuid, showSettings){
    ...
    // Container
//    var createnoticeContainer = createnews + "_container";
     ...
     */
    sakai.createnotice.initialise = function(){
        $(createnoticeContainer).jqmShow();
//        $("#createnotice_container").jqmShow();        
        $(".content_fields").show();
        tinyMCE.init({
            mode : "textareas",
            theme : "advanced",
...
sakai.api.Widgets.widgetLoader.informOnLoad("createnotice");